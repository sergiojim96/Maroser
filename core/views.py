...
class PaymentView(View):
    def get(self, *args, **kwargs):
        ...
        if order.billing_address:
            ...
            userprofile = self.request.session.session_key.userprofile
    ...
    def post(self, *args, **kwargs):
        ...
        userprofile = UserProfile.objects.get(user=self.request.session.session_key)
        if form.is_valid():
            ...
            if save:
                if userprofile.stripe_customer_id != '' and userprofile.stripe_customer_id is not None:
                    ...
                    customer = stripe.Customer.create(
                        email=self.request.session.session_key.email,
                    )
                    customer.sources.create(source=token)
            ...
            try:
                ...
                payment.user = self.request.session.session_key
